  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Off the journey path</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This stop doesn't exist on the NayePankh map.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "NayePankh Foundation — Empowering Dreams, Creating Change" },
      {
        name: "description",
        content:
          "Travel through the journey of NayePankh Foundation — programs, impact and stories of change across India.",
      },
