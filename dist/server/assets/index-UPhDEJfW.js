...
function JourneyPath() {
  ...
  return /* @__PURE__ */ jsx("div", { ref, className: "pointer-events-none absolute inset-0 z-0", children: /* @__PURE__ */ jsxs(
    "svg",
    {
      viewBox: `0 0 ${W} ${H}`,
      ...
      children: [
        /* @__PURE__ */ jsxs("defs", { children: [
          /* @__PURE__ */ jsxs("linearGradient", { id: "journeyGrad", x1: "0", x2: "0", y1: "0", y2: "1", children: [
            /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: "oklch(0.86 0.16 75)" }),
            /* @__PURE__ */ jsx("stop", { offset: "50%", stopColor: "oklch(0.78 0.17 60)" }),
            /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "oklch(0.68 0.16 25)" })
          ] }),
...
const pEdu = "/assets/program-education-23HlXT_d.jpg";
const pFood = "/assets/program-food-DipnbRvk.jpg";
const pWomen = "/assets/program-women-DdaujQYB.jpg";
const pEnv = "/assets/program-env-Cb5qYUYb.jpg";
...
function Nav({
  ...
  return /* @__PURE__ */ jsx(motion.header, { initial: {
    ...
    /* @__PURE__ */ jsx("nav", { className: "hidden items-center gap-7 text-sm text-ivory/80 md:flex", children: items.map((i) => /* @__PURE__ */ jsx("a", { href: `#${i.toLowerCase()}`, className: "transition hover:text-saffron", children: i }, i)) }),
    /* @__PURE__ */ jsx("a", { href: "#join", className: "rounded-full bg-saffron px-4 py-2 text-sm font-medium text-[var(--teal-deep)] transition hover:bg-saffron-glow", children: "Donate" })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsxs("section", { id: "top", ref, className: "relative isolate min-h-[100svh] overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx(motion.div, { style: {
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-9 flex flex-wrap items-center gap-4", children: [
        /* @__PURE__ */ jsxs("a", { href: "#about", className: "group inline-flex items-center gap-3 rounded-full bg-saffron px-6 py-3 text-sm font-medium text-[var(--teal-deep)] transition hover:bg-saffron-glow", children: [
          "Explore the journey",
          /* @__PURE__ */ jsx("span", { className: "transition group-hover:translate-x-1", children: "→" })
        ] }),
        /* @__PURE__ */ jsx("a", { href: "#join", className: "inline-flex items-center gap-3 rounded-full border border-ivory/20 px-6 py-3 text-sm font-medium text-ivory transition hover:border-saffron hover:text-saffron", children: "Become a volunteer" })
      ] })
    ] }) }),
...
function Stop({
  ...
  return /* @__PURE__ */ jsx("section", { id, ref, className: `relative mx-auto flex min-h-[90vh] max-w-7xl items-center px-6 py-28 ${side === "left" ? "justify-start" : "justify-end"}`, children: /* @__PURE__ */ jsxs(motion.div, { initial: {
    ...
    duration: 0.9,
    ease: "easeOut"
  }, className: "relative w-full max-w-2xl", children: [
