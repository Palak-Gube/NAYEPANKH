...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./_tanstack-start-manifest_v-c53yQxdU.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./_tanstack-start-server-fn-manifest_v-DtgTK7xl.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-BuOn97HX.js");
    }
    if (startEntry === null) {
      startEntry = await import("./start-B-dgpgxZ.js");
    }
    return {
      startEntry,
      routerEntry
